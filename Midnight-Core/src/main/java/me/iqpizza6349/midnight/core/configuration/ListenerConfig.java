...
public class ListenerConfig {
    ...
    public Map<String, Object> consumerConfigurations() {
        ...
        configurations.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, KafkaConstraints.KAFKA_BROKER);
        configurations.put(ConsumerConfig.GROUP_ID_CONFIG, KafkaConstraints.GROUP_ID);
